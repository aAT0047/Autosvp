...
def read_and_clean_csv(filename):
    ...
    # df_cleaned= df_cleaned.loc[df_cleaned['Sample'] == 100]
...
def process_sample(data):
    ...
    # min_mapping_threshold_values =[0,5,10] 
    # min_clip_values = [10,20]
    # read_length_values = [150,152]
    # min_non_overlap_values = [148,185]
    # discordant_z_values = [2,3,4,5]
  # 定义参数范围
    w_values = [10000]  # Modified this line to be a list
    msw_values = [2]
    tt_values = [0]
    back_distance_values = [10,20,30]
    min_mapping_threshold_values = [0,5,10,20]
    min_clip_values = [5,10,20]
    ...
    # 定义日志文件夹路径
    # log_folder = "/home/cloudam/simulat_2/log"
    ...
    with open(csv_file, 'wb') as f:
        f.write("msw,tt,back_distance,min_mapping_threshold,min_clip,read_length,min_non_overlap,discordant_z,mean, stdev,TP,FP,FN,f1_score, precision, recall\n")
    ...
    total_iterations = 1  # 初始化总迭代次数为1

    # 对每个迭代器的长度进行相乘，计算总迭代次数
    for values in [w_values, msw_values, tt_values, back_distance_values, min_mapping_threshold_values, min_clip_values, read_length_values, min_non_overlap_values, discordant_z_values]:
                            ...
                            for read_length in read_length_values:
                                for min_non_overlap in min_non_overlap_values:
                                    for discordant_z in discordant_z_values:
                                        ...
                                        target_folder = '/home/cloudam/simulat_2/vcfpro/'
                                        ...
                                        # 创建或打开CSV文件以追加内容
                                        with open(csv_file, 'a') as f:
                                            f.write("{},{},{},{},{},{},{},{},{},{},{},{},{},{},{},{}\n".format(msw, tt, back_distance, min_mapping_threshold, min_clip, read_length, min_non_overlap, discordant_z, mean, stdev,TP,FP,FN,f1_score, precision, recall))
