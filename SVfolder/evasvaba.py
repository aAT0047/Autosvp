...
def write_evaluation_to_csv(csv_file, evaluation_data):
    ...
    with open(csv_file, mode='a', newline='') as file:
        ...
        for row in evaluation_data:
            writer.writerow(row)
# 主函数执行流程
input_directory = "/data/home/std_12/ShiHe/results/sarcomabam/svaba"
output_directory = "/data/home/std_12/ShiHe/results/sarcomabam/svaba"
...
# 准备CSV文件
csv_file_path = os.path.join(output_directory, "Svaba.csv")
